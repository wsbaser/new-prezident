	...
	model(){
		...
		this.store.pushPayload({
			...
			playlists: [{
					...
					description: 'В августе 1999-го года создается блок "Единство" и уже через 4 месяца побеждает на выборах в Госдуму. 9-го августа Владимир Путин становится премьер министром, за полгода его рейтинг вырастает с 1.5 до 53%. В чем секрет этого успеха?',
				...
				},
				{
					...
					route: 'now',
					name: 'Пропаганда',
					description: 'Пропаганда - это предвзятая информация, распространяемая с целью убедить людей в  верности определенного мнения или позиции. Чтобы не позволить себя обмануть необходимо знать как она работает.',
